...
export class PlaygroundMainPage implements OnInit {
  ...
  setCanvasImages() {
    ...
    let imgElem3;
    for (let i = 0; i < this.sceneInfo[3].objs.imagesPath.length; i++) {
      imgElem3 = new Image();
      imgElem3.src = this.sceneInfo[3].objs.imagesPath[i];
    ...
    switch (this.currentScene) {
      ...
      case 2:
        ...
        if (scrollRatio > 0.9) {
          ...
          context.drawImage(objs.images[0], 0, 0);
      ...
      case 3:
        ...
        if (scrollRatio < values.rect1X[2].end) {
          ...
          context.drawImage(objs.images[1],
  ...
  softLoop() {
    ...
    if ((document.body.offsetHeight - window.innerHeight) - this.delayedYOffset < 1) {
      let tempYOffset = this.yOffset;
